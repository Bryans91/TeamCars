...
int main()
{
	...
	CarBodyDef.position = b2Vec2(600 / SCALE, 300 / SCALE);
	...
	while (Window.isOpen())
	{
		...
		{
			CarBody->ApplyForce(CarBody->GetWorldVector(b2Vec2(0, -5)), CarBody->GetWorldCenter(), true);
		}
